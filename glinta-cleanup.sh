...
# 2. Run authentication blocker cleanup  
log_message "Running authentication blocker cleanup..."
php -f enhanced_authentication_blocker.php cleanup >> $LOG_FILE 2>&1
BLOCKER_EXIT_CODE=$?
log_message "Authentication blocker cleanup exit code: $BLOCKER_EXIT_CODE"

# 3. Update cron check file to prevent warning
...
log_message "Summary: Cleanup=$CLEANUP_EXIT_CODE, Blocker=$BLOCKER_EXIT_CODE, CronCheck=$CRON_CHECK_EXIT_CODE"
