...
$htmlContent .= "                <!-- Navigation Links -->\n";
$htmlContent .= "                <div class=\"flex flex-col justify-center items-center h-34\">\n"; // Adjusted to a column layout
$htmlContent .= "                    <div class=\"mb-4 text-black text-center\">\n"; // Added margin bottom and text color
$htmlContent .= "                        <p class=\"text-lg font-semibold\">Voucher recharge</p>\n"; // Voucher recharge text
$htmlContent .= "                        <p class=\"text-sm\">(Call admin for voucher recharge in case your payment is not successful)</p>\n"; // Additional info text
$htmlContent .= "                    </div>\n";
$htmlContent .= "                    <div>\n";
$htmlContent .= "                        <button class=\"bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 text-lg rounded shadow-lg transform transition duration-300 hover:translate-y-1\" onclick=\"redeemVoucher()\">Redeem Voucher</button>\n";
$htmlContent .= "                    </div>\n";
$htmlContent .= "                </div>\n";
...
while ($plan = $planResult->fetch_assoc()) {
    $htmlContent .= "    <div class=\"flex flex-col rounded-xl shadow-lg overflow-hidden transform transition duration-500 hover:scale-105\">\n";
    $htmlContent .= "        <div class=\"px-4 py-5 bg-gradient-to-tr from-green-50 to-green-200 text-center rounded-t-xl\">\n";
    ...
    $htmlContent .= "            </p>\n";
    $htmlContent .= "        </div>\n";
    $htmlContent .= "        <div class=\"px-4 pt-4 pb-6 bg-green-500 text-center rounded-b-xl\">\n";
    ...
    $htmlContent .= "               onclick=\"handlePhoneNumberSubmission(this.getAttribute('data-plan-id'), this.getAttribute('data-router-id')); return false;\" data-plan-id=\"" . htmlspecialchars($plan['id']) . "\" data-router-id=\"" . htmlspecialchars($routerId) . "\">\n";
    $htmlContent .= "                BUY NOW\n";
    $htmlContent .= "            </a>\n";
    $htmlContent .= "        </div>\n";
    $htmlContent .= "    </div>\n";
...
$htmlContent .= "        </h3>\n";
$htmlContent .= "        <p class=\"mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto\">\n";
$htmlContent .= "            Call Admin : 0700804962.\n";
$htmlContent .= "        </p>\n";
$htmlContent .= "    </div>\n";
...
$htmlContent .= "                        html: `Remaining time: <b>\${formattedPhoneNumber}</b><br>
                            Payment request sent to: <b>\${formattedPhoneNumber}</b><br>
                            Please wait without clicking anything until you are connected.<br>
                            If still on this page after the timer ends, scroll down and click 'Login Now'.`,\n";
$htmlContent .= "                        timer: 30000, // Adjusted for 30 seconds\n";
...
$htmlContent .= "                                timer.textContent = `\${Math.ceil(Swal.getTimerLeft() / 1000)} seconds`;\n";
$htmlContent .= "                            }, 100);\n";
$htmlContent .= "                        },\n";
...
$htmlContent .= "                    var LoginphoneNumber = data.phone;\n";
$htmlContent .= "                     var Loginpassword = data.tyhK;\n";
$htmlContent .= "                    document.getElementById('usernameInput').value = LoginphoneNumber;\n";
$htmlContent .= "                    document.getElementById('passwordInput').value = Loginpassword;\n";
...
$htmlContent .= "                     document.getElementById('submitBtn').click();\n";
$htmlContent .= "                    }else{\n";
$htmlContent .= "                     console.log(\"No data found\");\n";
$htmlContent .= "                    }\n";
$htmlContent .= "                },\n";
