...
<head>
    ...
    <title>Glinta Africa - #1 Hotspot Billing Software for African ISPs | M-Pesa Integration</title>
    <meta name="description" content="🚀 Africa's #1 hotspot billing software with M-Pesa integration. Transform your ISP business with automated billing, real-time analytics & 99.9% uptime. Trusted by 5000+ ISPs across 25+ African countries. Start free trial today!">
    <meta name="keywords" content="hotspot billing software Africa, M-Pesa billing integration, WiFi monetization Kenya, ISP management Africa, internet billing software, African fintech solutions, hotspot management system, mobile money billing, RADIUS billing, WiFi billing software, ISP automation Africa, internet service provider software, African ISP solutions, Kenya internet billing, Nigeria WiFi billing, South Africa hotspot software">
    ...
    <meta property="og:title" content="Glinta Africa - From Zero to Hero in African Hotspot Billing">
    <meta property="og:description" content="Revolutionary hotspot billing platform designed for African ISPs. Features M-Pesa integration, automated customer management, and real-time revenue tracking.">
    ...
    <meta name="twitter:site" content="@glintaafrica">
    <meta name="twitter:creator" content="@glintaafrica">
    <meta name="twitter:title" content="Glinta Africa - African Hotspot Billing Solutions">
    <meta name="twitter:description" content="Transform your ISP business with Africa's most advanced billing platform. M-Pesa integration, automated billing & real-time analytics.">
    ...
    <script type="application/ld+json">
    {
      ...
      "name": "Glinta Africa Hotspot Billing",
      "description": "Revolutionary hotspot billing software for African ISPs with M-Pesa integration and automated customer management",
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://glintaafrica.com/ui/ui/images/logo.png"
        }
      }
    }
    </script>
        ...
        * {
        ...
        .hero {
            ...
            background: linear-gradient(135deg, rgba(248, 250, 252, 0.92) 0%, rgba(241, 245, 249, 0.95) 50%, rgba(255, 255, 255, 0.92) 100%), 
                        url('https://images.unsplash.com/photo-1551434678-e076c223a692?w=1600') center/cover no-repeat;
            position: relative;
            display: flex;
            align-items: center;
            overflow: hidden;
        ...
        .computer-mockup:hover .dashboard-image {
            transform: scale(1.02);
        }

        .computer-mockup:hover .demo-overlay {
            opacity: 1 !important;
        }
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center min-vh-100">
                <div class="col-lg-7">
                    <div class="hero-content">
                        <h1 class="hero-title animate__animated animate__fadeInUp">
                            ...
                            <span class="gradient-animated">IN AFRICAN HOTSPOT BILLING</span>
                        </h1>
                        <p class="hero-subtitle fs-5 mb-4 animate__animated animate__fadeInUp animate__delay-1s" style="color: var(--black-soft);">
                            Stop wrestling with spreadsheets and manual billing! 🎯 Our platform transforms chaos into cash flow. 
                            <strong style="color: var(--gold-dark);">Warning:</strong> May cause sudden profitability and uncontrollable business growth.
                        </p>
                        <div class="hero-features mb-5 animate__animated animate__fadeInUp animate__delay-2s">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <span style="color: var(--black-soft);"><strong style="color: var(--gold-dark);">M-Pesa Magic:</strong> Money appears faster than your morning coffee ☕</span>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="feature-check" style="width: 30px; height: 30px; background: var(--gradient-gold); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                                    <i class="fas fa-robot text-black"></i>
                                </div>
                                <span style="color: var(--black-soft);"><strong style="color: var(--gold-dark);">AI-Powered Automation:</strong> Your virtual assistant that never takes lunch breaks 🤖</span>
                            </div>
                            <div class="d-flex align-items-center mb-3">
                                <div class="feature-check" style="width: 30px; height: 30px; background: var(--gradient-gold); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem;">
                                    <i class="fas fa-chart-line text-black"></i>
                                </div>
                                <span style="color: var(--black-soft);"><strong style="color: var(--gold-dark);">Real-time Intelligence:</strong> Know your profits before your accountant does 📈</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="dashboard-demo animate__animated animate__fadeInRight animate__delay-1s" data-aos="zoom-in">
                        <div class="computer-mockup">
                            <!-- Computer Frame -->
                            <div class="computer-frame" style="background: linear-gradient(145deg, #2c3e50, #34495e); border-radius: 20px; padding: 20px; box-shadow: 0 25px 60px rgba(0,0,0,0.3);">
                                <!-- Screen Bezel -->
                                <div class="screen-bezel" style="background: #1a1a1a; border-radius: 15px; padding: 15px; position: relative;">
                                    <!-- Status Bar -->
                                    <div class="status-bar" style="background: #2c3e50; height: 25px; border-radius: 8px 8px 0 0; display: flex; align-items: center; padding: 0 15px;">
                                        ...
                                        <div style="flex: 1; text-align: center; color: #ecf0f1; font-size: 12px; font-weight: 500;">
                                            Glinta Africa Dashboard - Live Demo
                                        </div>
                                    </div>
                                    
                                    <!-- Dashboard Screenshot -->
                                    <div class="dashboard-screen" style="position: relative; overflow: hidden; border-radius: 0 0 8px 8px;">
                                        <img src="{$app_url}/ui/ui/images/dashboard-demo-updated.png" 
                                             alt="Glinta Africa Dashboard Demo" 
                                             style="width: 100%; height: auto; display: block; transition: transform 0.3s ease;"
                                             class="dashboard-image">
                                        
                                        <!-- Hover Overlay -->
                                        <div class="demo-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(212, 175, 55, 0.9); opacity: 0; transition: opacity 0.3s ease; display: flex; align-items: center; justify-content: center; cursor: pointer;">
                                            <div class="text-center text-white">
                                                <i class="fas fa-play-circle" style="font-size: 3rem; margin-bottom: 1rem;"></i>
                                                <h5>Click to Explore</h5>
                                                <p>See real-time data in action!</p>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <!-- Glowing effect indicators -->
                                    <div class="pulse-indicator" style="position: absolute; top: 50px; right: 20px; width: 10px; height: 10px; background: #27ae60; border-radius: 50%; animation: pulse 2s infinite;"></div>
                                    <div class="pulse-indicator" style="position: absolute; bottom: 50px; left: 30px; width: 8px; height: 8px; background: #3498db; border-radius: 50%; animation: pulse 2s infinite 0.5s;"></div>
                                </div>
                                
                                <!-- Computer Base -->
                                <div class="computer-base" style="height: 20px; background: linear-gradient(145deg, #34495e, #2c3e50); border-radius: 0 0 15px 15px; margin: 10px 20px 0; position: relative;">
                                    <div style="position: absolute; bottom: -15px; left: 50%; transform: translateX(-50%); width: 60px; height: 15px; background: linear-gradient(145deg, #2c3e50, #34495e); border-radius: 0 0 10px 10px;"></div>
                                </div>
                            </div>
                            
                            <!-- Floating Stats -->
                            <div class="floating-stats" style="position: absolute; top: -20px; right: -20px;">
                                <div class="floating-stat" style="background: rgba(46, 204, 113, 0.9); color: white; padding: 8px 12px; border-radius: 20px; font-size: 12px; font-weight: bold; margin-bottom: 8px; animation: float 3s ease-in-out infinite;">
                                    📈 +300% Revenue
                                </div>
                                <div class="floating-stat" style="background: rgba(52, 152, 219, 0.9); color: white; padding: 8px 12px; border-radius: 20px; font-size: 12px; font-weight: bold; animation: float 3s ease-in-out infinite 1s;">
                                    ⚡ 99.9% Uptime
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center mb-5">
                    <h2 class="display-4 fw-bold mb-4" data-aos="fade-up">Real Success Stories (Not Fake Testimonials) 😉</h2>
                    <p class="lead text-muted" data-aos="fade-up" data-aos-delay="100">
                        From "barely surviving" to "swimming in profits" - these ISP owners went from zero to hero. 
                        <strong>Plot twist:</strong> They're now our biggest competitors (in a good way)! 🚀
                    </p>
                </div>
            </div>
            ...
            <div class="success-gallery">
                <div class="success-card" data-aos="fade-up" data-aos-delay="200">
                    <img src="https://images.unsplash.com/photo-1516321497487-e288fb19713f?w=800" alt="Kenya Tech Success">
                    <div class="success-content text-white">
                        <h3>From Hustling to Ruling 👑</h3>
                        <p>"I went from counting coins to counting thousands! My M-Pesa notifications now sound like a Christmas carol 🎵. 500+ hotspots later, I'm the WiFi King of Nairobi!"</p>
                        <div class="mt-3">
                            <span class="badge bg-success text-white me-2">🇰🇪 Kenya</span>
                            <span class="badge bg-info text-white">💰 +400% Revenue</span>
                        </div>
                    </div>
                </div>
                
                <div class="success-card" data-aos="fade-up" data-aos-delay="300">
                    <img src="https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800" alt="Nigeria Tech Success">
                    <div class="success-content text-white">
                        <h3>Lagos Money Machine 💸</h3>
                        <p>"Started with 5 hotspots, now I own 1,000+! My neighbors think I'm into crypto, but it's just Glinta making me rich. Even my accountant is confused! 😂"</p>
                        <div class="mt-3">
                            <span class="badge bg-success text-white me-2">🇳🇬 Nigeria</span>
                            <span class="badge bg-warning text-dark">🚀 Scale Master</span>
                        </div>
                    </div>
                </div>
                
                <div class="success-card" data-aos="fade-up" data-aos-delay="400">
                    <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=800" alt="South Africa Tech Success">
                    <div class="success-content text-white">
                        <h3>Township to Millionaire 🏆</h3>
                        <p>"From struggling to pay rent to buying my landlord's building! Glinta turned my WiFi dream into a money-printing machine. Now I vacation in Dubai! ✈️"</p>
                        <div class="mt-3">
                            <span class="badge bg-success text-white me-2">🇿🇦 South Africa</span>
                            <span class="badge bg-danger text-white">🔥 Life Changed</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="services" class="py-5" style="background: linear-gradient(135deg, rgba(241, 245, 249, 0.9) 0%, rgba(248, 250, 252, 0.95) 100%), url('https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1600') center/cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 mx-auto text-center mb-5">
                    ...
                    <p class="lead text-muted" data-aos="fade-up" data-aos-delay="100">
                        Every feature designed with African businesses in mind - because we understand the hustle! 💪
                    </p>
                </div>
            </div>
    ...
    <section class="map-section">
        <div class="container">
            ...
            <div class="africa-interactive-map" data-aos="zoom-in">
                <div class="africa-tech-showcase" style="position: relative; border-radius: 20px; overflow: hidden; box-shadow: 0 15px 40px rgba(0,0,0,0.1);">
                    <img src="https://images.unsplash.com/photo-1488229297570-58520851e868?w=800" 
                         alt="Africa Tech Infrastructure" 
                         style="width: 100%; height: 400px; object-fit: cover;">
                    
                    <!-- Overlay with network connections -->
                    <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(135deg, rgba(212, 175, 55, 0.8), rgba(0, 0, 0, 0.6));">
                        <div class="d-flex align-items-center justify-content-center h-100">
                            <div class="text-center text-white">
                                <h3 class="fw-bold mb-3">🌍 Connecting Africa Through Technology</h3>
                                <p class="lead">From Cairo to Cape Town, our network spans the continent</p>
                                
                                <!-- Animated Network Nodes -->
                                <div class="network-nodes mt-4">
                                    <div class="node" style="position: absolute; top: 20%; left: 30%; width: 12px; height: 12px; background: #27ae60; border-radius: 50%; animation: pulse 2s infinite;"></div>
                                    <div class="node" style="position: absolute; top: 40%; left: 60%; width: 12px; height: 12px; background: #3498db; border-radius: 50%; animation: pulse 2s infinite 0.5s;"></div>
                                    <div class="node" style="position: absolute; top: 70%; left: 45%; width: 12px; height: 12px; background: #e74c3c; border-radius: 50%; animation: pulse 2s infinite 1s;"></div>
                                    <div class="node" style="position: absolute; top: 30%; left: 75%; width: 12px; height: 12px; background: #f39c12; border-radius: 50%; animation: pulse 2s infinite 1.5s;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- CTA Section -->
    <section class="py-5" style="background: linear-gradient(135deg, rgba(212, 175, 55, 0.9) 0%, rgba(244, 228, 193, 0.95) 100%), url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=1600') center/cover no-repeat;">
        <div class="container">
            <div class="row">
