...
<div class="row">
    ...
    <div class="col-md-6">
        <div
            class="card mb20 {if $trx['status']==1}card-warning{elseif $trx['status']==2}card-success{elseif $trx['status']==3}card-danger{elseif $trx['status']==4}card-danger{else}{/if} card-hovered">
