    ...
    <h1>
      <div class="btn-group">
          ...
          <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="{$app_url}/download.php?download=1" target="_blank">Download Login Page</a></li>
          </ul>
      </div>
  </h1>
    <ol class="breadcrumb">
        <li><a href="{$app_url}/download.php?download=1"><i class="fa fa-dashboard"></i> Click Here To Download Login Page</a></li>
